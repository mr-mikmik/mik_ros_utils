...
launch_rs_cameras(camera_names_and_ids, enable_pointcloud=enable_pointcloud, enable_infra=enable_infra, align_depth=align_depth, rate=rate, img_width=img_width, img_height=img_height, not_apriltags=args.not_apriltags)
